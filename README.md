...
SentenceTransformer-V2 is an extended and experimental version of the original **[sentence-transformers](https://github.com/huggingface/sentence-transformers)** library.
...
This repository builds upon the core functionality of the original Sentence Transformers library while introducing several enhancements for **embedding caching, semantic search utilities, and reusable search indexing**.
